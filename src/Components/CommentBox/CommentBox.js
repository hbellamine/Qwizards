     ...
     // end CommentForm component
      ...
      return (
        <form className="comment-form" onSubmit={handleSubmit}>
          ...
          <Form.Control onChange={(event)=>{setAuthorinput(event.target)}} style={{marginTop:10}}  type="text" placeholder="Author" /><br />
          <Form.Control onChange={(event)=>{setBodyinput(event.target)}} style={{marginTop:10}} rows="4" type="text" placeholder="Comment" />

          </div>
          <div className="comment-form-actions">
          <Button onClick = {handleSubmit} variant="contained" size='small' color='primary'>Post Comment</Button>
