        ...
        <Card className="success">
          <div class="img-wrap">
            <Card.Img
              ...
              src="https://images.unsplash.com/photo-1562585398-fbf461aec9a6?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=725&q=80"
              alt="Card image"
            />
          </div>
          <Card.ImgOverlay>
            <Card.Title className="successtxt">
              ...
              <div style={{ textAlign: "center" }}>
                You just added 50 points to your total quiz points
              </div>
              <div className="checkbutton">
                <Button variant="primary" onClick={adminpanel}>
                  Check my Dashboard
                </Button>
              </div>
            </Card.Title>
            ...
            return (
              <div className="card" style={{ width: "15rem" }} key={i}>
                <Card.Img
                  ...
                  src="https://www.flaticon.com/svg/static/icons/svg/3409/3409569.svg"
                  alt="Card image cap"
                ></Card.Img>
                <div className="card-body">
                  <h5 className="card-title">Question : {item.question}</h5>
                  <p className="card-text">
                    <strong>Your answer:</strong> {props.WrongUserAnswers[i]}
                  </p>
                  <p className="card-text">
                    <strong>Right answer :</strong> {item[right]}
                  </p>
                </div>
              </div>
            );
      ...
      <div>
        <Card className="success">
          <div className="img-wrap">
            <Card.Img
              src="https://image.freepik.com/free-photo/young-man-holding-hands-his-head-white-t-shirt-looking-sorry-front-view_176474-10206.jpg"
              alt="Card image"
            />
          </div>
          <Card.ImgOverlay>
            <Card.Title className="successtxt">
              ...
              <div style={{ textAlign: "center" }}>
                0 points added to your total quiz points
              </div>
              <div className="checkbutton">
                <Button variant="primary" onClick={adminpanel}>
                  Check my Dashboard
